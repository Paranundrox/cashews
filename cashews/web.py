...
async def stats(request: Request, team_id: str):
    ...
    defs_b = [
        ("PA", "plate_appearances", None, format_int, "Plate Appearances - Completed batting turns"),
        ("AB", "at_bats", None, format_int, "At Bats - Result of Plate Appearances subtracting Sacrifices and Walks"),
        ("R", "runs", None, format_int, "Runs - Times crossing home to score"),
        ("1B", "singles", None, format_int, "Singles - Times reaching first base on a hit"),
        ("2B", "doubles", None, format_int, "Doubles - Times reaching second base on a hit"),
        ("3B", "triples", None, format_int, "Triples - Times reaching third base on a hit"),
        ("HR", "home_runs", None, format_int, "Home Runs - Times scoring on a hit"),
        ("RBI", "runs_batted_in", None, format_int, "Runs Batted In - Runs scored as the result of player's Plate Appearances"),
        ("BB", "walked", None, format_int, "Walks - Times awarded first base due to walks, derived from 'Base on Balls'"),
        ("SO", "struck_out", None, format_int, "Strike Outs - Number of plate appearances ended due to striking out"),
        ("BA", "ba", True, format_float3, "Batting Average - Ratio of total Hits divided by total At Bats"),
        ("OBP", "obp", True, format_float3, "On-Base Percentage - Ratio of times reaching base to total Plate Appearances"),
        ("SLG", "slg", True, format_float3, "Slugging Percentage - Ratio of total number of bases reached per At Bats. Excludes Walks and Hit By Pitch"),
        ("OPS", "ops", True, format_float3, "On-Base Plus Slugging - The Sum of OBP and SLG combining hitting for average and power"),
        ("SB", "stolen_bases", None, format_int, "Stolen Bases - Count of bases advanced when not entitled"),
        ("CS", "caught_stealing", None, format_int, "Caught Stealing - Times thrown out while attempting to Steal"),
        ("SB%", "sb_success", True, format_float3, "Stolen Base Percentage - Ratio of successful Steal attempts to total attempts"),
    ]

    defs_p = [
        ("IP", "ip", None, format_ip, "Innings pitched"),
        ("G", "appearances", None, format_int, "Games - Total number of games pitching during"),
        ("GS", "starts", None, format_int, "Games Started"),
        ("W", "wins", None, format_int, "Wins - Count of Wins credited to pitcher"),
        ("L", "losses", None, format_int, "Losses - Count of Losses credited to pitcher"),
        ("CG", "complete_games", None, format_int, "Complete Games - Count of games where player was the sole pitcher"),
        ("SHO", "shutouts", None, format_int, "Shutouts - Count of Complete Games where the opposing team scored no Runs"),
        ("NH", "no_hitters", None, format_int, "No Hitters - Count of games where the opposing team achived no Hits"),
        ("SV", "saves", None, format_int, "Saves - Count of eligible games a Relief Pitcher preserved the team's lead"),
        ("BS", "blown_saves", None, format_int, "Blown Saves - Count of eligible games in which a Relief Pitcher allows the tying Run to score"),
        ("ERA", "era", False, format_float2, "Earned Run Average - Average of a Pitcher's Runs Allowed per Total Innings Pitched. Reported as an average per 9 Innings"),
        ("WHIP", "whip", False, format_float2, "Walks and Hits Per Inning Pitched"),
        ("HR/9", "hr9", False, format_float2, "Home Runs Allowed per 9 Innings"),
        ("BB/9", "bb9", False, format_float2, "Walks Allowed per 9 Innings"),
        ("K/9", "k9", True, format_float2, "Strikeouts per 9 Innings"),
        ("H/9", "h9", False, format_float2, "Hits Allowed per 9 Inning"),
    ]

    defs_f = [
        ("Putouts", "putouts", None, format_ip, "Putouts - Count of times credited with causing out for batter or runner"),
        ("Assists", "assists", None, format_int, "Assists - Times assisting a Putout"),
        ("Errors", "errors", None, format_int, "Errors - Times misplays allow runners to advance"),
        ("DP", "double_plays", None, format_int, "Double Plays"),
        ("FPCT", "fpct", None, format_float3, "Fielding Percent - Total Putouts and Assists divided by Total Putouts and Assists plus Errors"),
